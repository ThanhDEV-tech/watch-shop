...
Skill output is tracked as local markdown under `.agents/docs/`; do not use GitHub Issues or external trackers for this personal project. See `docs/agents/issue-tracker.md`.
