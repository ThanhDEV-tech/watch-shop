  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'product-variants', redirect: '/admin/products' },
        { path: 'brands', name: 'admin-brands', component: () => import('../views/admin/AdminBrandsView.vue') },
        ...
        { path: 'shipping-zones', name: 'admin-shipping-zones', component: () => import('../views/admin/ShippingZonesView.vue') },
