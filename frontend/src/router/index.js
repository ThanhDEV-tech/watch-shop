  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'courses', name: 'admin-courses', component: () => import('../views/admin/AdminCoursesView.vue') },
        { path: 'categories', name: 'admin-categories', component: () => import('../views/admin/AdminCategoriesView.vue') },
        { path: 'certifications', name: 'admin-certifications', component: () => import('../views/admin/AdminCertificationsView.vue') },
